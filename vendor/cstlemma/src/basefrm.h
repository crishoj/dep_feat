...
#if FREQ24
        basefrm(const char * s,const char * t,baseformpointer & owner,int len,/*int cnt,*/unsigned int frequency):fullForm(NULL),nfullForm(0),freq24(frequency),m_owner(owner)
#else
        basefrm(const char * s,const char * t,baseformpointer & owner,int len/*int cnt,*/):fullForm(NULL),nfullForm(0),m_owner(owner)
#endif
            {
